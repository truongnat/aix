...
**Partially implemented (v0.9.2 Step 4):** `install` verb alias, `--visibility`, `--ignore-strategy`, private `.git/info/exclude`, project `uninstall`, and project `update`. Global update remains design-only. See [installer-ux-v0.9.2-plan.md](installer-ux-v0.9.2-plan.md).

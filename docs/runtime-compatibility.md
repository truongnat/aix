...
OpenCode is **not** in the active provider scope as of v0.11.0. See [runtimes/opencode.md](runtimes/opencode.md) for legacy notes; use the shell/bootstrap fallback uninstall guidance in [uninstall-usage.md](uninstall-usage.md) to remove old installs.

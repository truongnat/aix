...
description: Expert optimization for Claude-native tools (Claude Code CLI, Projects, Artifacts). Focuses on long-context management and model-specific capabilities.
metadata:
  short-description: Claude Code — Tool Orchestration, Long-Context, Artifacts, Project Instructions
  content-language: en
...
| Artifacts Overview | [support.anthropic.com/en/articles/9487310-using-artifacts](https://support.anthropic.com/en/articles/9487310-using-artifacts) |

...
name: fullstack-pro
description: |
  Comprehensive Fullstack development in 2026: Next.js 15, Server Actions, shadcn/ui, and AI integration.
  Use this skill to architect, implement, and review end-to-end fullstack features.
metadata:
  short-description: Fullstack Pro 2026 — Next.js 15, Server Actions, shadcn/ui, AI SDK
  content-language: en
  domain: fullstack
  level: professional
---
...
Expert-level orchestration of modern fullstack applications. Follows the strict 2026 tech stack: Next.js 15, Server Actions, Tailwind CSS, shadcn/ui, and Vercel AI SDK.

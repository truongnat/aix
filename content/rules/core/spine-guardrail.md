...
**Path:** `.aix/sessions/<sessionId>/` only. Do **not** use `.planning/` (GSD) or other harness folders for these files.

For any non-trivial task, you must generate and update the following artifacts inside that directory:

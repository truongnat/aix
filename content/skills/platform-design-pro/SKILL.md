...
description: >
  Cross-platform design system expertise covering iOS Human Interface Guidelines
  (HIG),
  ...
  Use when building native mobile apps, cross-platform apps, or need
  platform-specific

  design guidance with accessibility compliance.


  Triggers: "iOS HIG", "Human Interface Guidelines", "Material Design",
  "cross-platform design", "platform patterns", "native feel", "platform
  conventions", "Android design", "iOS design", "platform UX".
x-kind: domain
x-version: 0.1.0
x-roles: []
x-tags: []

...
name: grill-me-pro
description: >
  Conduct a relentless, systematic interview about a plan or design — one
  question at a time — until every branch of the decision tree is resolved and
  both parties share a clear understanding. Does NOT produce a plan; produces
  shared understanding. Use when the user wants their design stress-tested,
  their assumptions challenged, or their thinking sharpened before committing to
  implementation.


  Triggers: "grill me", "stress-test this", "challenge my design", "interview me
  about", "push back on", "find holes in", "play devil's advocate", "critique my

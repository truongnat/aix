...
description: >
  ...
  Triggers: "motion design", "Framer Motion", "GSAP", "page transition", "scroll
  animation", "micro-interaction", "hover animation", "choreographed motion",
  "CSS animation", "animation timing".
x-kind: domain
x-version: 0.1.0
x-roles: []
x-tags: []

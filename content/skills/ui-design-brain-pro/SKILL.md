...
description: >
  Production-grade UI component knowledge from 60+ documented interface
  patterns.
  ...
  Triggers: "UI pattern", "component pattern", "onboarding modal", "interaction
  states", "choose component", "UI flow", "pattern library", "component
  archetype", "dashboard pattern", "form pattern".
x-kind: domain
x-version: 0.1.0
x-roles: []
x-tags: []

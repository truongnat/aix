...
description: >
  ...
  Design system component discovery, variable extraction, and incremental screen
  building.


  Use when implementing Figma designs in code, connecting design system
  components,

  or building screens section-by-section from design files.


  Triggers: "Figma", "MCP", "Figma MCP", "design to code", "component mapping",
  "token extraction", "responsive strategy", "implement this Figma", "Figma
  file", "Figma node".
x-kind: domain
x-version: 0.1.0
x-roles: []

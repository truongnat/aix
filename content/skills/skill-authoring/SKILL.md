...
description: >
  Create, validate, and publish professional-grade skills following the strict
  six-layer architecture and SKILL_AUTHORING_RULES.md format. Covers SKILL.md
  structure, references strategy, Cursor rules (.mdc), and publishing to the
  Skill Hub.


  Use this skill when creating a new skill, refactoring an existing skill,
  writing Cursor rules, or publishing skills to the hub.


  Triggers: "create skill", "new skill", "SKILL.md", "publish skill", "cursor
  rule", "skill template", ".mdc", "skill authoring", "write a skill"
x-kind: domain
x-version: 0.1.0
x-roles: []
x-tags: []

...
How to build the call to `confirmVisualResult` (from `tools/preview`) so it satisfies the `Output Contract` in `SKILL.md`. You generate the HTML; this guide covers the inputs and the contract you must honor.
...
The comparison page you generate, following `tools/preview/references/design-guide.md`:

...
function buildInstallPlan(options) {
    ...
    for (const providerId of options.providers) {
        ...
        if (options.installCache && (0, cli_providers_1.isRuntimeNative)(providerId) && !willInstall.includes(".ai-harness/")) {
    ...
    return { willInstall, willNotModify, mode: options.mode, isGit: options.isGit, providers: options.providers };
}

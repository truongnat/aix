...
exports.buildEvalRecommendations = buildEvalRecommendations;
exports.formatEvalRecommendations = formatEvalRecommendations;
...
function buildEvalRecommendations(targetRoot) {
    const insights = (0, index_1.buildInsights)(targetRoot);

...
exports.runInsightsCommand = runInsightsCommand;
...
async function runInsightsCommand(_packRoot, options) {
    ...
    // @ts-ignore - JS file with checkJs
    const { buildEvalRecommendations, formatEvalRecommendations, } = require("../insights/eval-recommendations");
    // @ts-ignore - JS file with checkJs
    const { uploadInsightsExport } = require("../insights/remote-upload");
    const target = node_path_1.default.resolve(options.target || ".");

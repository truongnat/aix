...
const { workers, VALID_PROVIDER_SUPPORT, WORKER_IDS } = require("../../workers/registry.js");
const { assertClaudeWorkerSurface } = require("../worker-claude-adapter.js");
  ...
  for (const worker of workers) {
    ...
    if (!providerSupport) {
      ...
      for (const value of Object.values(providerSupport)) {
        if (!VALID_PROVIDER_SUPPORT.includes(value)) {

...
exports.HARNESS_COMMAND_PATTERN = void 0;
exports.assertExists = assertExists;
exports.assertHeadings = assertHeadings;
exports.assertNonEmpty = assertNonEmpty;
exports.extractMachineField = extractMachineField;
exports.extractMarkdownSection = extractMarkdownSection;
exports.hasConcreteFailureRule = hasConcreteFailureRule;
exports.hasSubstantiveSectionBody = hasSubstantiveSectionBody;
exports.isPlaceholderBullet = isPlaceholderBullet;
exports.parseFrontmatter = parseFrontmatter;
exports.parseNestedFrontmatterMap = parseNestedFrontmatterMap;
...
exports.HARNESS_COMMAND_PATTERN = HARNESS_COMMAND_PATTERN;
function resolvePath(baseDir, relativePath) {
    return node_path_1.default.join(baseDir, relativePath);
}
...
function readFile(baseDir, relativePath) {
    return node_fs_1.default.readFileSync(resolvePath(baseDir, relativePath), "utf8");
}

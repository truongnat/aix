const { root, commandFiles, commandHeadings, executionHeadings, gatesHeadings, goalArtifactHeadings, harnessHeadings, memoryHeadings, packRequiredHeadings, promptTemplateFiles, promptTemplateHeadings, requiredFiles, selectedSkillsHeadings, skillFiles, skillHeadings, skillTemplateHeadings, taskHeadings, teamHeadings, templateFiles, VALID_TARGET_RUNTIMES } = (() => {
...
const { extractMarkdownSection, hasConcreteFailureRule, hasSubstantiveSectionBody } = require("./utils.js");
const {
  ...
  if (args.mode === "target-goal") {
    console.log(
      args.runtime
        ...
        : `Target repository validation passed. Checked goal contract: ${args.goalId}.`
    );
    return;
  }

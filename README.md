...
Release notes: [docs/v1.2.0-release-notes.md](docs/v1.2.0-release-notes.md)
...
**v1.2.0**: patch release removing the redundant `init` command, hardening the `install` flow for non-git targets and provider prompts, and expanding the Codex plugin install surface. Replace `init` with `install` in scripts.

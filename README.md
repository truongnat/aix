...
- Next planned: `v0.7.0` Capability Pack Packaging ([plan](docs/v0.7.0-plan.md) · [model](docs/packaging-model.md) · [verify](docs/pack-verification-checklist.md) · [PACK.md](PACK.md))

---
description: feature advanced workflow with deterministic gates and report quality guard
---
# Workflow: feature
...
Input: Analyze task scope, constraints, and acceptance criteria for feature. Return strict JSON with summary/actions/risks.

## Step: execution_plan
Skill: agent.llm_subagent
DependsOn: intent_analysis
Input: Build deterministic implementation plan for feature with milestones, validation, and rollback notes.
...
Retry: 1
OnFailure: FailFast
Input: echo "validate feature"

## Step: risk_review
Skill: agent.llm_subagent
DependsOn: validation_gate
Input: Produce risk register for feature, including severity, blast radius, and mitigations.
...
Input: Advanced scaffold workflow feature prepared with report-quality and simulation-fallback gates.

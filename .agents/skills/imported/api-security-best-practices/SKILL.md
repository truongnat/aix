...
```json
{
  ...
  "source_license": "MIT",
  "source_path": "api-security-best-practices/SKILL.md",
...
## Imported Notes
Imported from requested source `/tmp/agentic-sdlc-curated/antigravity-workflow-skills`; resolved source `/private/tmp/agentic-sdlc-curated/antigravity-workflow-skills`; path `api-security-best-practices/SKILL.md`.

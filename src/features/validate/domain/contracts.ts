...
import {
  legacyRuntimeCommandCatalog,
  legacyWorkerRegistry,
  legacyWorkerClaudeAdapter,
  legacyDomainSkillGeneration,
...
const { fileReferencesActivation } = legacyRuntimeCommandCatalog;
const { workers, VALID_PROVIDER_SUPPORT, WORKER_IDS } = legacyWorkerRegistry;
const { assertClaudeWorkerSurface } = legacyWorkerClaudeAdapter;
const { listDomainDefinitions } = legacyDomainSkillGeneration;

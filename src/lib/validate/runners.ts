...
const api =
  require("../../features/validate/application/runners.js") as typeof import("../../features/validate/application/runners");
...
export type ValidationContext =
  import("../../features/validate/application/runners").ValidationContext;
export type Validator = import("../../features/validate/application/runners").Validator;
